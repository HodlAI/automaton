 ...
 * - x402_domain_allowlist denies non-hodlai.fun domains
...
describe("Financial Policy Rules", () => {
  ...
  describe("financial.x402_domain_allowlist", () => {
    it("allows requests to hodlai.fun domains", () => {
      const request = createRequest(
        mockX402Tool(),
        { url: "https://gw.hodlai.fun/v1/resource" },
    ...
    it("denies requests to subdomains of non-allowlisted domains", () => {
      const request = createRequest(
        mockX402Tool(),
        { url: "https://hodlai.fun.evil.com/drain" },
        createMockSpendTracker(),
      );
    ...
    it("allows subdomain of hodlai.fun", () => {
      const request = createRequest(
        mockX402Tool(),
        { url: "https://pay.hodlai.fun/endpoint" },
        createMockSpendTracker(),
      );
